...
To date, I have authored over 10 scholarly articles and actively participate as a peer reviewer for top-tier journals and conferences such as T-CVST, T-NNLS, IJCV, AAAI, IJCAI, ACMMM, and so on. My work primarily explores the intersections of image processing and compression in digital media technologies.

## Achievements
My research team, Kingslayer, secured third place in the Perceptual Metric Track at the 5th Workshop and Challenge on Learned Image Compression, Conference on Computer Vision and Pattern Recognition 2022. 
...
- `IJCAI 2025` Kepeng Xu, **Li Xu**, Gang He, Wei Chen, Xianyun Wu, Wenxin Yu. Unleashing the Potential of Transformer Flow for Photorealistic Face Restoration [C]. Proceedings of the Thirty-Fourth International Joint Conference on Artificial Intelligence, Montreal, Canada, 2025.

- `IJCAI 2025` Gang He, Kepeng Xu, **Li Xu**, Zhiqiang Zhang, Wenxin Yu, Shihao Wang, Dajiang Zhou, Yunsong Li. Beyond Feature Mapping GAP: Integrating Real HDRTV Priors for Superior SDRTV-to-HDRTV Conversion [C]. Proceedings of the Thirty-Fourth International Joint Conference on Artificial Intelligence, Montreal, Canada, 2025.
